...
"""
This code is extracted from the repository 
https://github.com/architecture-building-systems/RC_BuildingSimulator
copyright: "Copyright 2016, Architecture and Building Systems - ETH Zurich"
credits: "pysolar, Quaschning Volker,  Rolf Hanitsch, Linus Walker"
SPDX-FileCopyrightText: Prageeth Jayathissa <p.jayathissa@gmail.com>
...
class Location(
    ...
    def __init__(self, epwfile_path):
        ...
        # Read the latitude and longitude from the first row
        self.weather_data_first_row = pd.read_csv(
            epwfile_path,
            skiprows=lambda x: x != 0,  # Skip all rows except the first one
            header=None,
            encoding="ISO-8859-1",
            engine="python"
        )
        # Extract latitude and longitude as float values
        latitude = float(self.weather_data_first_row[6][0])
        longitude = float(self.weather_data_first_row[7][0])
        self.weather_data_latitude_and_longitude = {}
...
class Window(object):
    ...
    def calc_solar_heat_gains_by_pv(
        self,
